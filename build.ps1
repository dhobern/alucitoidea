...
sed -i -e "s/^version: .*$/version: 1.0.$versionid\r/" -e "s/^released: .*$/released: $releasedate\r/" -e "s/Version .* includes updates/Version 1.1.$versionid includes updates/" coldp/metadata.yaml
