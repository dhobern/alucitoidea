...
sed -e "s/Version .* has been updated/Version $versionshort has been updated/" -e "s/<h2>Catalogue of the Alucitoidea of the World, .*</<h2>Catalogue of the Alucitoidea of the World, version $versionid</" index.php > index.tmp
copy index.tmp index.php
erase index.tmp
sed -e "s/<h2>Catalogue of the Alucitoidea of the World, .*</<h2>Catalogue of the Alucitoidea of the World, version $versionid</" catalogue.php > catalogue.tmp
